...
def setup_logger(log_dir):
    ...
    log_file = os.path.join(log_dir, f"experiment_log_large_{current_time}.txt")
...
def get_model_and_tokenizer(model_name):
    model_configs = {
        ...
        'electra': 'hfl/chinese-electra-180g-large-discriminator',
        'ernie': 'nghuyong/ernie-3.0-xbase-zh',
...
def main():
    ...
    model_names = ['roberta', 'xlnet', 'electra', 'ernie', 'deberta']
